...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Añadir Orden
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Administrar Ordenes
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Editar ordenes
		<?php } ?>
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Fecha de la Orden</label>
			    <div class="col-sm-10">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:20%;">Tasa de Producto</th>
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Total de la Cuenta</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Valor Adeudado</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType">
				      	...
				      	<option value="3">Tarjeta de Créditos</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">~~SELECCIONA~~</option>
				      	<option value="1">Pagado Completamente</option>
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add Row </button>
			      ...
			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Resetear</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Total de la Deuda</label>
				    <div class="col-sm-9">
			  ...
			  <div class="form-group editButtonFooter">
			    <div class="col-sm-offset-2 col-sm-10">
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Agregar más Productos</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;" >
      	...
      	<div class="paymentOrderMessages"></div>
			  ...
			  <div class="form-group">
			    <label for="payAmount" class="col-sm-3 control-label">Valor Pagado</label>
			    <div class="col-sm-9">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>¿Realmente quieres eliminar la orden?</p>
      </div>
